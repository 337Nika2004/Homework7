public class Main {
    public static void main(String[] args) {
        ...
        int t = 2_459_000; // Целевая сумма
        int m = 15_000; // Ежемесячный вклад
        int c = 0;      // Текущие накопления
        int months = 0; // Количество месяцев
        while (c < t) {
            c = c + m; // Добавляем ежемесячный вклад
            months = months + 1; // Увеличиваем счетчик месяцев
            System.out.println("Месяц " + months + " , сумма накоплений равна " + c + " рублей.");
        }
        ...
        int targetAmount = 12_000_000; // целевая сумма
        ...
        int summ = 15000; // первоначальная сумма вклада
        int targetAmount1 = 12000000; // целевая сумма
        int percentage = 7; // процентная ставка
        int month1 = 0; // количество месяцев
        while (summ < targetAmount1) {
            summ = summ + summ * percentage / 100; // добавляем 7% к текущей сумме
        ...
        int months1 = 108;
        int percentage1 = 7;
        while (month2 < months1) {
            summ1 += summ1 * percentage1/100;
            month2 = month2 + 1;
            if (month2 % 6 == 0)
                System.out.println("Месяц " + month2 +
                        " , сумма накоплений равна " + summ1 + " рублей");
        }
